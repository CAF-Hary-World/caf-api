-- DropForeignKey
ALTER TABLE "ServicePermission" DROP CONSTRAINT "ServicePermission_providerId_fkey";
...
-- AddForeignKey
ALTER TABLE "ServicePermission" ADD CONSTRAINT "ServicePermission_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "Provider"("id") ON DELETE CASCADE ON UPDATE CASCADE;
