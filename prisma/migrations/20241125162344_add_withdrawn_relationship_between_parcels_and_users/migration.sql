...
-- AlterTable
ALTER TABLE "Parcel" ADD COLUMN     "withdrawnById" TEXT,
...
-- AddForeignKey
ALTER TABLE "Parcel" ADD CONSTRAINT "Parcel_withdrawnById_fkey" FOREIGN KEY ("withdrawnById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
